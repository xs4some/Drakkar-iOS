...
- (NSString *)tableView:(UITableView *)tableView titleForHeaderInSection:(NSInteger)section {
    if (section == 0) {
        return NSLocalizedString(@"Please enter your Drakkar username and password, so you can check your balance with this app!", @"Explanatory text on activation screen");
    }
